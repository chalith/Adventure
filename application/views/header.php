    ...
    <head>
        ...
        <script>
            ...
            function register() {
                ...
                if (about == "") {
                    alert("Please write about your services");
                    return;
                }
                                    ...
                                    <div class="content"><br>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form  class="form-horizontal" name="customerRegister" id="customerRegister" role="form" method="post" action="<?php echo base_url('index.php/welcome/registerCustomer'); ?>" accept-charset="utf-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4">User-Name:<span style="color:red">*</span></label>
                                                        <div class="col-md-6">
